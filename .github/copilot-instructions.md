...
## Project overview
- vNES is a C++20 NES emulator built as a single binary (Makefile) with SFML for graphics/audio/input.
...
- Use advanced C++ features up to C++20 and maintain code clarity.